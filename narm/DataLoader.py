...
if __name__=="__main__":
    train, valid, test = load_data('yoochoose1_64/', valid_portion=0.1, maxlen=19, sort_by_len=False)
    train_data = RecSysDataset(train)
    data_loader = DataLoader(train_data, batch_size=6, shuffle=True, collate_fn=collate_fn)